...
- (bool)setupRound:(int)round
{
	...
	switch (round)
	{
		...
		case 7:
		{
            ...
            Player *enemy2 = [[Player alloc] init];
            [enemy2 setColor:[[aiWarsViewController colors] objectAtIndex:6]];
            [enemy2 setIsComputer:0];
            [enemy2 setName:@"Tard"];
            [enemy2 setRoundsWon:0];
            [enemy2 setBotsKilled:0];
            [enemy2 setBotsDestroyed:0];
